...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutines() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.coroutines");
        }
    ...
    public static class AndroidxHiltLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hilt.nav.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class HiltAndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>test</b> with <b>com.google.dagger:hilt-android-testing</b> coordinates and
         * with version reference <b>hilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getTest() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("hilt.android.test");
        }
    ...
    public static class MockitoLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>mockito.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class HiltVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        private final HiltNavVersionAccessors vaccForHiltNavVersionAccessors = new HiltNavVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.hilt.nav</b>
         */
        public HiltNavVersionAccessors getNav() {
            return vaccForHiltNavVersionAccessors;
        }

    }

    public static class HiltNavVersionAccessors extends VersionFactory  {

        public HiltNavVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>hilt.nav.version</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("hilt.nav.version"); }
    ...
    public static class MockitoVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>mockito.android</b> with value <b>5.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroid() { return getVersion("mockito.android"); }
